...
pub struct TradingConfig {
    ...
    pub max_utilization: i128,  // Max total_notional / vault_assets ratio (token_decimals)
...
pub struct MarketConfig {
    ...
    pub maintenance_margin: i128, // Maintenance margin threshold, determines liquidation price (token_decimals)
    pub base_fee: i128,           // Base trading fee percentage (token_decimals)
